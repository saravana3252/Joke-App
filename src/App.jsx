  ...
  return (
    <>
      <div className="relative h-screen w-full">
        <img src="./joke-app-bg.jpg" className="h-full w-full object-cover" alt="joke App Background"></img>
        <div className="bg-orange-700 lg:w-1/2 lg:h-auto absolute w-[90%] top-[210px] left-[20px]  lg:top-[220px] lg:left-[330px] lg:p-5 p-3 shadow-xl rounded ">
